  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto">
        ...
        {/* Profile info */}
        <div className={`pt-20 px-4 pb-8 rounded-t-lg min-h-screen ${theme === 'ghast' ? 'bg-gray-300' : (theme === 'pizza' || theme === 'dark') ? 'bg-black' : theme === 'buzzy' ? 'bg-white' : theme === 'bazimazi' ? 'bg-white' : 'bg-white'}`}>
          <div className="mb-6">
