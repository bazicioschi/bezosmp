  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto">
        ...
        {/* Profile info */}
        <div className={`pt-20 px-4 pb-8 rounded-t-lg min-h-screen ${theme === 'ghast' ? 'bg-gray-300' : (theme === 'pizza' || theme === 'dark') ? 'bg-black' : theme === 'buzzy' ? 'bg-yellow-400' : theme === 'bazimazi' ? 'bg-white' : 'bg-white'}`}>
          <div className="mb-6">
          ...
          <div className="space-y-6">
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" className={`w-full border-destructive hover:bg-destructive/10 ${theme === 'bazimazi' ? 'text-black' : 'text-destructive'}`} size="lg">
