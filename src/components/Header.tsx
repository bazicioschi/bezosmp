    ...
    <header className="sticky top-0 z-50 border-b-4 border-primary/30 bg-background/95 backdrop-blur-xl minecraft-grass-top">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/20 border-2 border-primary/30 minecraft-block-hover group-hover:shadow-glow transition-all duration-300">
