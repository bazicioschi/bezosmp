...
const socialLinks = [
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/bazicioschi/',
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
  ...
  {
    name: 'YouTube',
    url: 'https://youtube.com/Bazicioschi',
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
  ...
  {
    name: 'Xbox',
    url: 'https://xbox.com/Bazicioschi',
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
        <path d="M4.102 21.033A11.947 11.947 0 0012 24a11.947 11.947 0 007.898-2.967c1.46-1.885-4.394-8.543-7.898-11.08-3.504 2.537-9.358 9.195-7.898 11.08zM12 3.545S8.063 0 4.816 2.13C2.871 3.392 1.476 5.543.83 8.01c.647-.027 4.23 3.167 11.17 9.584C18.94 11.177 22.523 7.983 23.17 8.01c-.647-2.467-2.042-4.618-3.986-5.88C15.937 0 12 3.545 12 3.545z" />
      </svg>
    ),
  },
  {
    name: 'TikTok',
    url: 'https://tiktok.com/@Bazicioschi',
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
